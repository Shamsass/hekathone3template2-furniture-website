...
// import { allProducts, four } from "@/sanity/lib/queries";
// import { client } from "@/sanity/lib/client"; // Assuming this is the client initialization
// import { product, product as ProductType } from "../../../scripts/types/products"; // Avoid naming conflicts
// import { urlFor } from "@/sanity/lib/image";
// import Link from 'next/link'
...
//             </p>
//             <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover: shadow-lg hover :scale-110 transition-transform duration-300 case-in-out
//             " 
